...
Partial Public Class NorthwindDataClassesDataContext
  ...
  #End Region
	...
	Public Sub New()
		MyBase.New(Global.L2S_Northwind_VB.My.MySettings.Default.NorthwindConnectionString, mappingSource)
		OnCreated
	End Sub
	...
	Public Function Employee_Sales_by_Country(<Parameter(Name:="Beginning_Date", DbType:="DateTime")> ByVal beginning_Date As System.Nullable(Of Date), <Parameter(Name:="Ending_Date", DbType:="DateTime")> ByVal ending_Date As System.Nullable(Of Date)) As ISingleResult(Of Employee_Sales_by_CountryResult)
...
Partial Public Class SalesByCategoryResult
	...
	<Column(Storage:="_TotalPurchase", DbType:="Decimal(0,0)")>  _
